...
unzip -p $CURPWD/$RNA.RNAsubopt.zip | barriers --rates -G RNA -M noShift --bsize --max=999999 --minh=0 > $CURPWD/$RNA.barriers.out;
# store rate matrix generated by barriers
mv rates.out $CURPWD/$RNA.barriers.rates;
